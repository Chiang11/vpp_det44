...
#ifndef __included_jxt_inlines_h__
#define __included_jxt_inlines_h__

static_always_inline int
jxt_is_interface_addr (vlib_node_runtime_t * node,
			 u32 sw_if_index0, u32 ip4_addr)
{
  jxt_runtime_t *rt = (jxt_runtime_t *) node->runtime_data;
 ...
 */
static_always_inline int
jxt_translate (vlib_node_runtime_t * node, u32 sw_if_index0,
  ...
  if (FIB_NODE_INDEX_INVALID != fei)
      ...
      if (sw_if_index != ~0)
	{
	  jxt_interface_t *i;
	    ...
	    if ((jxt_interface_is_outside (i)) && (sw_if_index == i->sw_if_index))
              return 0;
          }
          /* *INDENT-ON* */
	}
...
#endif /* __included_jxt_inlines_h__ */
